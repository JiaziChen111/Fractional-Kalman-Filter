  ...
  %卡尔曼滤波
        ...
        temp_fun = 3*sin( 2*(X_esti(1,k-1)+h_con*S_chol) ) - (X_esti(1,k-1)+h_con*S_chol) - ...
          ...
          P_pred = 1/(4*h_con^2) * temp_fun^2 + rema_P + ...
                   ...
                   1/h_con*(-bino_fir(1,2))*S_chol*0.5*temp_fun' + Q_esti(k-1);
        ...
        Q_esti(k) = ( (k-1)*Q_esti(k-1) + (Kk*( Z_meas(1,k) - Z_esti ))^2 + ...
                       P_esti(1,k) - P_pred + Q_esti(k-1) )/k;
